...
% So, in order to do an optimization, you have to have costs. We defined some cost functions.
% The obvious cost function is like what we talked about, which is minimizing joint torques.
% We did it like this:
...
Here something is said about the genetic algorithm and so on...
